...
| **Open-Meteo Elevation API** | 25 points within 2 km of the LKP, **rounded to 3 dp**, for terrain relief. **Rural LKPs only**: urban LKPs never make this call | Anonymous (keyless) | Per Open-Meteo's public terms; no account |
