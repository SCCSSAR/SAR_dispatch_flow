#!/bin/bash
# =============================================================================
# build-sccssar-dev.sh — Build, push, and deploy to the SCCSSAR dev GCP project
#
# Usage:  bash build-sccssar-dev.sh
#
# Before running:
...
#   5. Ensure Docker is authenticated to Artifact Registry (see step 7 in
#      docs/deployment-guide.md §SCCSSAR deploy)
#
# See also: build-dev.sh for the personal dev project.
# =============================================================================
set -e
